export const nlTranslations = {
  ...
  "blogPosts": {
    "week-4-react-native-development": {
    "title": "Start van de Ontwikkeling met React Native en .NET",
    "excerpt": "De ontwikkelfase is begonnen! Ik ben gestart met het bouwen van de mobiele app met React Native en Expo, en een .NET backend. Een week vol coderen, leren en samenwerken.",
    "tags": ["React Native", "Expo", ".NET", "App Ontwikkeling", "Teamsamenwerking"],
    "content": "Deze week markeerde de spannende overgang van ontwerp naar ontwikkeling. Na weken van onderzoek, wireframes en prototypes, ben ik eindelijk begonnen met het bouwen van de mobiele app met **React Native** en **Expo**, gekoppeld aan een **.NET backend**.\n\nHet werken met React Native is zowel uitdagend als belonend geweest. Het framework maakt cross-platform ontwikkeling mogelijk, en ik begin steeds beter te begrijpen hoe componenten, navigatie en styling samenwerken. Dankzij Expo verloopt het testproces op verschillende apparaten verrassend soepel.\n\nAan de backend-kant heb ik onderzocht hoe onze .NET API gebruikersauthenticatie, winkeldata en productinformatie zal afhandelen. Het is interessant om te zien hoe de frontend- en backendteams samenwerken om ervoor te zorgen dat de endpoints precies aansluiten op wat de app nodig heeft.\n\nOnze **vrijdagse teammeeting** was opnieuw een waardevol moment voor feedback. Ik liet een kleine prototype van het startscherm van de app zien en kreeg nuttige suggesties over het verbeteren van de laadschermen en de navigatiestroom. Het is geweldig om te zien hoe samenwerking helpt om zowel de technische als de gebruikerservaring te verfijnen.\n\nDaarnaast ben ik dieper ingedoken in best practices voor het structureren van React Native projecten, het asynchroon ophalen van data en het efficiënt beheren van state. Elke dag voelt als een nieuwe leerervaring, en ik ben erg gemotiveerd om de app stukje bij beetje tot leven te zien komen!"
  },
  "week-3-finalizing-app-designs": {
    "title": "Ontwerpen Afronden en Voorbereiden op de Ontwikkeling",
    "excerpt": "De ontwerpfase is afgerond! Deze week heb ik het mobiele app-ontwerp in Figma afgerond, nieuwe plugins geleerd en de bestanden klaargemaakt voor de ontwikkelfase.",
    "tags": ["Figma", "UI Ontwerp", "App Prototyping", "Team Feedback", "Design Handoff"],
    "content": "Deze week draaide volledig om het afronden van het mobiele app-ontwerp. Na meerdere iteraties en feedbackrondes heb ik de belangrijkste schermen afgerond en een gepolijst prototype gemaakt dat klaar is voor de ontwikkelfase.\n\nIk heb veel tijd besteed in **Figma**, waar ik verschillende **plugins** heb geleerd te gebruiken om mijn workflow te versnellen — van iconbibliotheken tot auto-layout en kleurbeheer. Deze tools hielpen me om consistentie te behouden tussen schermen en de design-assets efficiënt voor te bereiden voor export.\n\nEen belangrijk aandachtspunt deze week was het verbeteren van de visuele hiërarchie en de toegankelijkheid van de app — ervoor zorgen dat tekstgroottes, contrasten en interacties intuïtief aanvoelen op mobiele apparaten. Daarnaast heb ik de belangrijkste componenten en ontwerppatronen gedocumenteerd om de overdracht naar ontwikkeling soepel te laten verlopen.\n\nTijdens onze **vrijdagse teammeeting** heb ik de definitieve ontwerpen gepresenteerd en waardevolle feedback ontvangen van zowel ontwerpers als ontwikkelaars. Iedereen was enthousiast om het eindresultaat te zien, en er kwamen interessante suggesties binnen over animaties en overgangseffecten die later in de code geïmplementeerd kunnen worden.\n\nVolgende week begin ik officieel aan de **ontwikkelfase**, met **React Native** en **.NET**. Ik kijk ernaar uit om de overstap te maken van ontwerpen naar programmeren — het is spannend om de visuele ideeën nu echt tot leven te brengen!"
  },
