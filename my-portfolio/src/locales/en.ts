export const enTranslations = {
  ...
  "hero": {
    "greeting": "Hello, I'm Yassine",
    "description": "A young and eager to learn Full-Stack Developer focused on building beautiful web applications and exploring cloud technologies.",
    "cta": "View My Work"
  },
  "about": {
    "title": "About Me",
    "description": "I'm a Computer Programming student at Artesis Plantijn University. I love combining creativity and logic to build impactful applications. Outside coding, you'll find me playing football, traveling, or exploring the world on my motorcycle."
  },
  "skills": {
    "title": "Skills",
  ...
  "projects": {
    ...
    "items": {
      ...
      "countryQuiz": {
        ...
        "description": "Simple mobile game where you guess countries and capitals based on the flag.",
        "source": "View App"
      },
      "examPlatform": {
        "title": "Exam Platform",
        "description": "This was a school project that I made in a group of 5 people divided over front and back end and testing. It is an in-house exam training platform for the employees of the company B.Ignited. (username and password are \"user\")",
        "source": "View website"
      }
    }
  },
  "contact": {
    "title": "Contact Me",
    "subtitle": "Interested in working together or have any questions? Feel free to reach out!",
    "name": "Name",
    "email": "Email",
    "message": "Message",
    "send": "Send Message"
  ...
  "blog": {
    ...
    "subtitle": "Follow my weekly adventures as a Full-Stack Developer at Yina Solutions. From team meetings to mobile app designs, here's what I'm learning and building.",
    "readMore": "Read More",
    ...
    "noPostsDesc": "Check back soon for updates on my internship journey!",
    "readTime": "min read",
    "week": "Week"
  },
  "footer": {
