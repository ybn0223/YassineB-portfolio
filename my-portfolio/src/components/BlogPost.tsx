...
export default function BlogPost() {
  ...
  const getLocalizedBlogPost = (post: BlogPostType) => {
    ...
    if (blogPostTranslations && typeof blogPostTranslations === 'object') {
      return {
        ...
        content: blogPostTranslations.content || post.content,
      };
    }
    return post;
  };
          ...
          <div className="p-8 sm:p-12">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="flex flex-wrap gap-2">
                {localizedPost.tags.map((tag: string) => (
                  <span
                    key={tag}
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          ...
          {(() => {
            ...
            return prevPost ? (
              ...
              >
                <div className="text-sm text-gray-500 dark:text-gray-400 mb-2">{t('blog.previousPost')}</div>
                <div className="font-semibold text-gray-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-200">
                  {getLocalizedBlogPost(prevPost).title}
                </div>
              </Link>
            ) : null;
          })()}
          ...
          {(() => {
            ...
            return nextPost ? (
              ...
              >
                <div className="text-sm text-gray-500 dark:text-gray-400 mb-2">{t('blog.nextPost')}</div>
                <div className="font-semibold text-gray-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-200">
                  {getLocalizedBlogPost(nextPost).title}
                </div>
              </Link>
            ) : null;
          })()}
